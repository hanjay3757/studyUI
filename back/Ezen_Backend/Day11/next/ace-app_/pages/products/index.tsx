...
export default function AllProductPage({products, totalCount}:Props) { //getServerSideProps함수가 반환하는 props가 들어옴
  ...
  return (
    <div style={{padding:'2rem'}} className={styles.container}>
        ...
        <div>
            <label>정렬방식
                <select style={{marginLeft:8,marginRight:8}} onChange={handleSortChange}>
...
export async function getServerSideProps(context:any){
    try {
        //url의 querystring값 받기 SSR일 경우 context.query 를 이용해서 받는다
